                ...
                <div className="form pb-2 border-bottom">
                    <div className="form-group row">
                        ...
                        <div className="col-sm-10">
                            <input type="text" ref="judulArtikel" className="form-control" id="title" name="title" onChange={this.handleTambahArtikel}/>
                        </div>
                    </div>
                    <div className="form-group row">
                        <label htmlFor="body" className="col-sm-2 col-form-label">Isi</label>
                        <div className="col-sm-10">
                            <textarea ref = "isiArtikel" className="form-control" id="body" name="body" rows="3" onChange={this.handleTambahArtikel}></textarea>
                        </div>
                    </div>
